...
def calculate():
    ...
    for i in range(f):
        num1.remove(-8)
    den1=[float(entbox1c.get()),float(entbox2c.get()),float(entbox3c.get()),float(entbox4c.get()),float(entbox5c.get()),float(entbox6c.get()),float(entbox7c.get()),float(entbox8c.get())]
    f2 = den1.count(-8)
    for i2 in range(f2):
        den1.remove(-8)
...
param=tk.Label(window,text='IF UNNEEDED EXTRA CLASSES, INPUT "-8"',fg='black',font='Helvetica 8 bold')
param.grid(column=2,row=10)
title1=tk.Label(window,text='Class',fg='white',bg='grey',font='Helvetica 12 bold')
title1.grid(column=1,row=1)
cl1=tk.Label(window,text='Class 1',fg='white',bg='grey',font='Helvetica 12 bold')
cl1.grid(column=1,row=2)
cl2=tk.Label(window,text='Class 2',fg='white',bg='grey',font='Helvetica 12 bold')
cl2.grid(column=1,row=3)
cl3=tk.Label(window,text='Class 3',fg='white',bg='grey',font='Helvetica 12 bold')
cl3.grid(column=1,row=4)
cl4=tk.Label(window,text='Class 4',fg='white',bg='grey',font='Helvetica 12 bold')
cl4.grid(column=1,row=5)
cl5=tk.Label(window,text='Class 5',fg='white',bg='grey',font='Helvetica 12 bold')
cl5.grid(column=1,row=6)
cl6=tk.Label(window,text='Class 6',fg='white',bg='grey',font='Helvetica 12 bold')
cl6.grid(column=1,row=7)
cl7=tk.Label(window,text='Class 7',fg='white',bg='grey',font='Helvetica 12 bold')
cl7.grid(column=1,row=8)
cl8=tk.Label(window,text='Class 8',fg='white',bg='grey',font='Helvetica 12 bold')
cl8.grid(column=1,row=9)
grade=tk.Label(window,text='Grade',fg='white',bg='grey',font='Helvetica 12 bold')
grade.grid(column=2,row=1)
credit=tk.Label(window,text='Credits',fg='white',bg='grey',font='Helvetica 12 bold')
credit.grid(column=3,row=1)
gpalab=tk.Label(window,text="Potential Gpa:",bg='grey',fg='white',font='Helvetica 12 bold')
