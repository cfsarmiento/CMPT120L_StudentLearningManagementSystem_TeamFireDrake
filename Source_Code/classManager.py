...
def CLASS_MANAGER(course):
    ...
    '''
    headerTitleLabel = Label(window, width = 170, height = 50, bg="grey", fill="white", font=('Helvetica 12 bold'), text = "Assignment Type")
    headerTitleLabel.create_text(80,25, text="Assignment Type", fill="white", font=('Helvetica 12 bold'))
    headerTitleLabel.grid(row=1,column=0)
    '''
    ...
    headerGradeLabel.grid(row=1,column=1)
        ...
        for columnIndex in range(0,2):
            match columnIndex:
                case 0:
                    ...
                    canvas.grid(row=rowIndex+2,column=columnIndex)
                case 1:
